...
public class WeekendStudent extends CurrentStudent {
	...
	public WeekendStudent(String sname,String city,String status,double totalfee,double feebals,String timings,String branch,String wcompany,String wcemail,double wctc) {
